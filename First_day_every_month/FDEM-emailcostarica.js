...
const emailcrFDEM = async (html) => {
  ...
  const params = {
    ...
    // to: ['cristian.supelano@fastmoda.com.co','yeimy.jimenez@fastmoda.com.co','diego.garcia@fastmoda.com.co','andres.hernandez@fastmoda.com.co','kevin.castillo@fastmoda.com.co','dany.pardo@fastmoda.com.co','nassim@dvpty.com','admin@lilipinkcr.com','david@lilipink.com'], 
    to: ['yeimy.jimenez@fastmoda.com.co', 'cristian.supelano@fastmoda.com.co'],
...
exports.emailcrFDEM = async () => {
  try {
    const { html } = await tableEmailAccumulated();
    await emailcrFDEM(html);
