...
const emailveFDEM = async (html, csvData) => {
  ...
  const params = {
    ...
    // to: ['cristian.supelano@fastmoda.com.co','yeimy.jimenez@fastmoda.com.co','diego.garcia@fastmoda.com.co','andres.hernandez@fastmoda.com.co','michel@lilipinkcr.com','admin@lilipinkcr.com','daniel.zeledon@lilipinkcr.com','sharon.benzaquen@lilipinkcr.com','brigitte.cabezas@lilipinkcr.com','david@lilipink.com'],
...
exports.emailveFDEM = async () => {
  const { html, csvData } = await tableEmailAccumulated();
  await emailveFDEM(html, csvData);
