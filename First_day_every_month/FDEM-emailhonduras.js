...
const emailhnFDEM = async (html, csvData) => {
  const transporter = nodemailer.createTransport({
    SES: ses,
  });
  ...
  const params = {
    from: 'cristian.supelano@fastmoda.com.co 🇭🇳 Venta_Lili_Honduras',
    to: ['cristian.supelano@fastmoda.com.co','yeimy.jimenez@fastmoda.com.co','diego.garcia@fastmoda.com.co','kevin.castillo@fastmoda.com.co','andres.hernandez@fastmoda.com.co','marcela.montenegro@lilipink.hn','daniela.velasquez@lilipink.hn','yeimy.angulo@fastmoda.com.co','nassim@dvpty.com','david@lilipink.com'],
    // to: ['cristian.supelano@fastmoda.com.co'],
...
exports.emailhnFDEM = async () => {
  try {
    const { html, csvData } = await tableEmailAccumulated();
    await emailhnFDEM(html, csvData);
