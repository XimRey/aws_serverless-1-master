...
const sendErrorEmail = async (error) => {
  ...
  const params = {
    from: 'cristian.supelano@fastmoda.com.co 🇬🇹 Venta_Lili_Guatemala',
      ...
      FROM
          (
              ...
              SELECT 
                  ...
                  SUM(sol.qty_invoiced) as "Unid 2024"
      ...
      FULL OUTER JOIN
          (
              ...
              SELECT 
                  ...
                  SUM(sol.qty_invoiced) as "Unid 2025"
              FROM odooguatemala.sale_order_line sol
              LEFT JOIN odooguatemala.general_users tbl ON sol.create_uid = tbl.create_uid
...
const emailgtFDEM = async (html) => {
  ...
  const params = {
    from: 'cristian.supelano@fastmoda.com.co 🇬🇹 Venta_Lili_Guatemala',
    to: ['cristian.supelano@fastmoda.com.co','yeimy.jimenez@fastmoda.com.co','diego.garcia@fastmoda.com.co','kevin.castillo@fastmoda.com.co','andres.hernandez@fastmoda.com.co','marcela.montenegro@lilipink.hn','daniela.velasquez@lilipink.hn','karla.palacios@fastmoda.com.co','nassim@dvpty.com','david@lilipink.com'],
...
exports.emailgtFDEM = async () => {
  try {
    const { html } = await tableEmailAccumulated();
    await emailgtFDEM(html);
